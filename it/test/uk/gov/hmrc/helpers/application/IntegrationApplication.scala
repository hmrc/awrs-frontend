...
trait IntegrationApplication extends GuiceOneServerPerSuite with WireMockSupport {
  ...
  def appConfig(extraConfig: (String, String)*): Map[String, Any] = Map(
    ...
    "microservice.services.awrs-lookup.host"                    -> wireMockHost,
    "microservice.services.awrs-lookup.port"                    -> wireMockPort,
    "microservice.services.business-customer.host"              -> wireMockHost,
