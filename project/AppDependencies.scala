...
private object AppDependencies {
  ...
  val compile = Seq(
    ...
    "uk.gov.hmrc" %% "bootstrap-play-26" % "1.13.0", // includes the global object and error handling, as well as the FrontendController classes and some common configuration
