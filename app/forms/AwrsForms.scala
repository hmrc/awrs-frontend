...
//  val TypeOfBusinessConstraint: Constraint[Option[String]] = Constraint("awrs.business_verification.error.type_of_business_empty")({ businessType =>
//    businessType.nonEmpty match {
//      case true => Valid
//      case false => Invalid("awrs.business_verification.error.type_of_business_empty")
//    }
//  })
