...
case class InputTypeRadioGroupParams(field: Field,
                                     ...
                                     inputClass: Option[String] = Some("govuk-radios__input"),
                                     legend: Option[String] = None,
                                     legendClass: Option[String] = Some("govuk-fieldset__legend govuk-fieldset__legend--l"),
                                     legendId: Option[String] = None,
                                     legendAttributes: Option[String] = None,
                                     fieldSetClass: Option[String] = Some("govuk-fieldset"),
                                     ...
                                     labelClass: Option[String] = Some("govuk-label govuk-radios__label"),
