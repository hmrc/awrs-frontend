...
class ApplicationConfig @Inject()(val servicesConfig: ServicesConfig,
  ...
  private lazy val contactFormServiceIdentifier = "AWRS"
  ...
  private lazy val enrolmentsServiceHost: String = servicesConfig.getConfString("enrolment-store-proxy.host", "enrolment-store-proxy.protected.mdtp")
  private lazy val enrolmentsServicePort: String = servicesConfig.getConfString("enrolment-store-proxy.port", "443")
  ...
  private lazy val loginCallback: String = loadConfig("auth.login-callback.url")
  private lazy val loginPath: String = loadConfig("auth.login-path")
  ...
  lazy val addTaxesFrontEndUrl: String = loadConfig("add-taxes-frontend.serviceRedirectUrl")
