...
class BusinessCustomerSessionCache @Inject() (servicesConfig: ServicesConfig, mongoComponent: MongoComponent, timestampSupport: TimestampSupport)(
    implicit ec: ExecutionContext)
    extends SessionCacheRepository(
      mongoComponent = mongoComponent,
      collectionName =
        servicesConfig.getConfString("microservice.services.cachable.session-cache.review-details.cache", "business-customer-frontend"),
...
class AwrsSessionCache @Inject() (servicesConfig: ServicesConfig, mongoComponent: MongoComponent, timestampSupport: TimestampSupport)(implicit
    ec: ExecutionContext)
    extends SessionCacheRepository(
      mongoComponent = mongoComponent,
