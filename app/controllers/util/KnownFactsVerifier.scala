...
import models.reenrolment.{AwrsRegisteredPostcode, Identifier, KnownFactsResponse, Verifier}

object KnownFactsVerifier {
  def knownFactsVerified(knownFactsResponse: Option[KnownFactsResponse], arws: String, isSA: Boolean, utr: AwrsEnrolmentUtr, postCode: AwrsRegisteredPostcode): Boolean = {
