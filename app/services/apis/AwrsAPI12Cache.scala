...
trait AwrsAPI12Cache {
  ...
  def getNotificationCache(status: FormBundleStatus, authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier): Future[Option[StatusNotification]] =
  ...
  @inline def getAlertFromCache(implicit hc: HeaderCarrier, request: Request[AnyContent]): Future[Option[StatusNotification]] =
  ...
  @inline def getNotificationViewedStatus(authRetrievals: StandardAuthRetrievals)
                                         (implicit hc: HeaderCarrier): Future[Option[ViewedStatusResponse]] =
