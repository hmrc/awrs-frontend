...
class Save4LaterService @Inject()(mainStoreSave4LaterConnector: AwrsDataCacheConnector,
  ...
  trait MainStore extends Save4LaterUtil {
    ...
    @inline def saveBusinessType(businessTypeData: BusinessType, authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[BusinessType] =
      saveData4Later[BusinessType](businessTypeName, businessTypeData, authRetrievals)

    @inline def fetchBusinessType(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[BusinessType]] =
      fetchData4Later[BusinessType](businessTypeName, authRetrievals)

    @inline def fetchBusinessAddress(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[BCAddress] =
      fetchData4Later[BusinessCustomerDetails](businessCustomerDetailsName, authRetrievals).map(_.map(_.businessAddress).get)

    @inline def saveBusinessCustomerDetails(authRetrievals: StandardAuthRetrievals, businessCustomerDetailsData: BusinessCustomerDetails)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[BusinessCustomerDetails] =
      saveData4Later[BusinessCustomerDetails](businessCustomerDetailsName, businessCustomerDetailsData, authRetrievals)

    @inline def fetchBusinessCustomerDetails(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[BusinessCustomerDetails]] =
      fetchData4Later[BusinessCustomerDetails](businessCustomerDetailsName, authRetrievals)

    @inline def saveNewApplicationType(newApplicationTypeData: NewApplicationType, authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[NewApplicationType] =
      saveData4Later(newApplicationTypeName, newApplicationTypeData, authRetrievals)

    @inline def fetchNewApplicationType(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[NewApplicationType]] =
      fetchData4Later[NewApplicationType](newApplicationTypeName, authRetrievals)

    @inline def saveGroupMembers(authRetrievals: StandardAuthRetrievals, data: GroupMembers)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[GroupMembers] =
      saveData4Later[GroupMembers](groupMembersName, data, authRetrievals)

    @inline def fetchGroupMembers(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[GroupMembers]] =
      fetchData4Later[GroupMembers](groupMembersName, authRetrievals)

    @inline def saveGroupDeclaration(authRetrievals: StandardAuthRetrievals, groupDeclarationData: GroupDeclaration)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[GroupDeclaration] =
      saveData4Later[GroupDeclaration](groupDeclarationName, groupDeclarationData, authRetrievals)

    @inline def fetchGroupDeclaration(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[GroupDeclaration]] =
      fetchData4Later[GroupDeclaration](groupDeclarationName, authRetrievals)

    @inline def saveBusinessDirectors(authRetrievals: StandardAuthRetrievals, data: BusinessDirectors)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[BusinessDirectors] =
      saveData4Later[BusinessDirectors](businessDirectorsName, data, authRetrievals)

    @inline def fetchBusinessDirectors(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[BusinessDirectors]] =
      fetchData4Later[BusinessDirectors](businessDirectorsName, authRetrievals)

    @inline def savePartnerDetails(authRetrievals: StandardAuthRetrievals, data: Partners)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Partners] =
      saveData4Later[Partners](partnersName, data, authRetrievals)

    @inline def fetchPartnerDetails(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[Partners]] =
      fetchData4Later[Partners](partnersName, authRetrievals)

    @inline def saveAdditionalBusinessPremisesList(authRetrievals: StandardAuthRetrievals, data: AdditionalBusinessPremisesList)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[AdditionalBusinessPremisesList] =
      saveData4Later[AdditionalBusinessPremisesList](additionalBusinessPremisesName, data, authRetrievals)

    @inline def fetchAdditionalBusinessPremisesList(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[AdditionalBusinessPremisesList]] =
      fetchData4Later[AdditionalBusinessPremisesList](additionalBusinessPremisesName, authRetrievals)

    @inline def saveTradingActivity(authRetrievals: StandardAuthRetrievals, tradingActivity: TradingActivity)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[TradingActivity] =
      saveData4Later[TradingActivity](tradingActivityName, tradingActivity, authRetrievals)

    @inline def fetchTradingActivity(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[TradingActivity]] =
      fetchData4Later[TradingActivity](tradingActivityName, authRetrievals)

    @inline def saveProducts(authRetrievals: StandardAuthRetrievals, products: Products)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Products] =
      saveData4Later[Products](productsName, products, authRetrievals)

    @inline def fetchProducts(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[Products]] =
      fetchData4Later[Products](productsName, authRetrievals)

    @inline def saveSuppliers(authRetrievals: StandardAuthRetrievals, data: Suppliers)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Suppliers] =
      saveData4Later[Suppliers](suppliersName, data, authRetrievals)

    @inline def fetchSuppliers(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[Suppliers]] =
      fetchData4Later[Suppliers](suppliersName, authRetrievals)

    @inline def saveApplicationDeclaration(authRetrievals: StandardAuthRetrievals, applicationDeclarationData: ApplicationDeclaration)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[ApplicationDeclaration] =
      saveData4Later[ApplicationDeclaration](applicationDeclarationName, applicationDeclarationData, authRetrievals)

    @inline def fetchApplicationDeclaration(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[ApplicationDeclaration]] =
      fetchData4Later[ApplicationDeclaration](applicationDeclarationName, authRetrievals)

    @inline def saveBusinessDetails(authRetrievals: StandardAuthRetrievals, businessDetails: BusinessDetails)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[BusinessDetails] =
      saveData4Later(businessDetailsName, businessDetails, authRetrievals)

    @inline def fetchBusinessDetails(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[BusinessDetails]] =
      fetchData4Later[BusinessDetails](businessDetailsName, authRetrievals)

    @inline def saveNoneBusinessRegistrationDetails(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[BusinessRegistrationDetails]] =
      saveData4Later[Option[BusinessRegistrationDetails]](businessRegistrationDetailsName, None, authRetrievals)

    @inline def saveBusinessRegistrationDetails(authRetrievals: StandardAuthRetrievals, businessDetails: BusinessRegistrationDetails)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[BusinessRegistrationDetails] =
      saveData4Later(businessRegistrationDetailsName, businessDetails, authRetrievals)

    @inline def fetchBusinessRegistrationDetails(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[BusinessRegistrationDetails]] =
      fetchData4Later[BusinessRegistrationDetails](businessRegistrationDetailsName, authRetrievals)

    @inline def saveBusinessContacts(authRetrievals: StandardAuthRetrievals, businessContacts: BusinessContacts)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[BusinessContacts] =
      saveData4Later(businessContactsName, businessContacts, authRetrievals)

    @inline def fetchBusinessContacts(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[BusinessContacts]] =
      fetchData4Later[BusinessContacts](businessContactsName, authRetrievals)

    @inline def savePlaceOfBusiness(authRetrievals: StandardAuthRetrievals, placeOfBusiness: PlaceOfBusiness)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[PlaceOfBusiness] =
      saveData4Later(placeOfBusinessName, placeOfBusiness, authRetrievals)

    @inline def fetchPlaceOfBusiness(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[PlaceOfBusiness]] =
      fetchData4Later[PlaceOfBusiness](placeOfBusinessName, authRetrievals)

    @inline def saveApplicationStatus(authRetrievals: StandardAuthRetrievals, applicationStatus: ApplicationStatus)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[ApplicationStatus] =
      saveData4Later(applicationStatusName, applicationStatus, authRetrievals)

    @inline def fetchApplicationStatus(authRetrievals: StandardAuthRetrievals)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[ApplicationStatus]] =
  ...
  lazy val mainStore: MainStore = new MainStore {
    override val accountUtils: AccountUtils = accUtils
